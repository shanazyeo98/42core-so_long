...
/*   Updated: 2024/08/16 11:44:11 by shayeo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	initimgs(t_game *game)
{
	...
	game->gameimg.ptr = mlx_new_image(game->win.mlx_ptr, game->map.rowlength \
	* IMG_W, game->map.rows * IMG_H);
	...
	game->win.win_ptr, game->gameimg.ptr, 0, 0);
}
...
void	initgame(t_game *game)
{
	...
	IMG_W * game->map.rowlength, IMG_H * game->map.rows, "Shibuya Incident!!");
